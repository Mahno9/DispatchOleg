...
export const TEXTS = {
  ...
  namePrompt: 'ПРЕДСТАВЬТЕСЬ, ДИСПЕТЧЕР',
  ...
  successText: 'ДИСПЕТЧЕР ПОДКЛЮЧЁН. ДОБРО ПОЖАЛОВАТЬ В СМЕНУ.',
...
export const STEP_STATUS: Record<OnboardingStep, string> = {
  ...
  name: 'ИДЕНТИФИКАЦИЯ ДИСПЕТЧЕРА',
  hint: 'ТРЕБУЕТСЯ ВИДЕОКАНАЛ',
  scanning: 'ПОИСК КОДА…',
  success: 'ДИСПЕТЧЕР ПОДКЛЮЧЁН',
};
